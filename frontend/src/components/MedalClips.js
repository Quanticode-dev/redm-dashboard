      ...
      {playingVideo && (
        ...
        >
          ...
          >
            ...
            {playingVideo.rawFileUrl && playingVideo.rawFileUrl !== "not_authorized" ? (
              <video 
                controls 
                autoPlay
                style={{ width: '100%', maxHeight: '80vh', borderRadius: '8px' }}
                src={playingVideo.rawFileUrl}
              />
            ) : (
              <div style={{ 
                background: '#fff', 
                ...
                <p style={{ marginBottom: '20px', fontSize: '18px' }}>
                  Video kann nicht direkt abgespielt werden.
                </p>
                <a 
                  href={playingVideo.directClipUrl}
                  target="_blank"
