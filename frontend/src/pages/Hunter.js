      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_4fr_3fr_3fr] gap-6">
        ...
        <div>
          <div className="rdr-card">
            ...
            <div className="space-y-3 scroll-container" style={{ maxHeight: '690px', overflowY: 'auto' }}>
              {inventory.map((item) => (
        ...
        <div>
          <div className="rdr-card">
            ...
            <div className="space-y-2 scroll-container" style={{ maxHeight: '690px', overflowY: 'auto' }}>
              {protocol.map((log) => (
