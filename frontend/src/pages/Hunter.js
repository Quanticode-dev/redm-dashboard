      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_4fr_3fr_3fr] gap-6">
        ...
        <div style={{ height: 'fit-content' }}>
          <div className="rdr-card" style={{ height: '100%' }}>
            ...
            <div className="space-y-3 scroll-container" style={{ maxHeight: '706px', overflowY: 'auto' }}>
        ...
        <div style={{ height: 'fit-content' }}>
          <div className="rdr-card" style={{ height: '100%' }}>
            ...
            {saleItems.length === 0 ? (
              ...
              <>
                <div className="space-y-3 mb-4 scroll-container" style={{ maxHeight: '550px', overflowY: 'auto' }}>
                  {saleItems.map((item) => (
        ...
        <div style={{ height: 'fit-content' }}>
          <div className="rdr-card" style={{ height: '100%' }}>
            ...
            <div className="space-y-2 scroll-container" style={{ maxHeight: '706px', overflowY: 'auto' }}>
              {protocol.map((log) => (
